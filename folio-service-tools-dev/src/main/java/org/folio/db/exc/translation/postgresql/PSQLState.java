...
public enum PSQLState {
  ...
  public boolean belongToClassOf(PSQLState other) {
    return getCodeClass().equals(other.getCodeClass());
  }

  public boolean belongToClassOf(String sqlStateCode) {
    return normalizeCode(sqlStateCode).startsWith(getCodeClass());
  }
  ...
  private static String normalizeCode(String code) {
    return defaultString(code).toUpperCase();
  }
